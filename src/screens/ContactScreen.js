    ...
    render: () => {
        ...
        <div class="col-lg-8 col-md-8 col-10 offset-lg-2 offset-md-2 offset-1">
            ...
            <div class="col-lg-4 col-md-4 col-12 ">
                ...
                <i class="fa fa-map-marker-alt" style="font-size:30px;color:rgb(22 22 23 / 93%)"></i><br>
                    <div class="footer-div">
                        <p>Address</p>
                        <p>Laxmi Nagar, Chandmari</p>
                        <span>Khamgaon, 444 303 </span>
                    </div>
                    <hr class="visible-xs" style="border: 1px solid rgb(22 22 23 / 93%); width: 180px;">
                </div>
            </div>

            <div class="col-lg-4 col-md-4 col-12 ">
                <div class="text-center footer-bg">
                    <i class="fa fa-envelope footer-icon" style="font-size:30px;color:rgb(22 22 23 / 93%);font-weight:250"></i><br>
                    <div class="footer-div">
                        <p class="contact-txt">General Enquiries</p>
                        <span>shubhsharmass24@gmail.com</span>
                    </div>
                    <hr class="visible-xs text-center" style="border: 1px solid rgb(22 22 23 / 93%); width: 180px;">
                </div>
            </div>

            <div class="col-lg-4 col-md-4 col-12">
                <div class="text-center footer-bg">
                    <i class="fa fa-phone" style="font-size:30px;color:rgb(22 22 23 / 93%)"></i><br>
                    <div class="footer-div">
                        <p>Call Us</p>
                        <p>+91-8983222814</p>
            ...
            <div class="col-lg-12 col-md-12 col-12">
                <div class="text-center footer-bg">
                    <i class="fa fa-clock-o" style="font-size:30px;color:rgb(22 22 23 / 93%)"></i><br>
                    <div class="footer-div">
                        <p>Hours : </p>
